    ...
    public class Кабинет : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КабинетE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КабинетE", typeof(IIS.Stomatologiya.Кабинет));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КабинетL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КабинетL", typeof(IIS.Stomatologiya.Кабинет));
                }
            }
        }
    }
