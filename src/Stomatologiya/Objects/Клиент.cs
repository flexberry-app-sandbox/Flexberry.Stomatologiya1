...
namespace IIS.Stomatologiya
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Stomatologiya.DetailArrayOfДокументы fДокументы;
        ...
        public virtual IIS.Stomatologiya.DetailArrayOfДокументы Документы
        {
            get
            {
                ...
                {
                    this.fДокументы = new IIS.Stomatologiya.DetailArrayOfДокументы(this);
                }
                IIS.Stomatologiya.DetailArrayOfДокументы result = this.fДокументы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Stomatologiya.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Stomatologiya.Клиент));
                }
            }
        }
    }
